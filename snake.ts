...
const GAME_PLACEMENT_INTERVAL = Math.floor(5 * GAME_TICKS_PER_SECOND);
const GAME_APPLE_PROBABILITY = 0.80;
const GAME_ORANGE_PROBABILITY = 0.15;
const GAME_APPLE_LIFETIME = Math.floor(15 * GAME_TICKS_PER_SECOND);
const GAME_ORANGE_LIFETIME = Math.floor(7 * GAME_TICKS_PER_SECOND);
